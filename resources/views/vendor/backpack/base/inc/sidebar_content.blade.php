...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('language-data') }}'><i class='nav-icon la la-question'></i> Languages data</a></li>

<li class='nav-item'><a class='nav-link' href='{{ backpack_url('set-furniture') }}'><i class='nav-icon la la-question'></i> Set furnitures</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('user') }}'><i class='nav-icon la la-question'></i> Users</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('species') }}'><i class='nav-icon la la-question'></i> Species</a></li>
